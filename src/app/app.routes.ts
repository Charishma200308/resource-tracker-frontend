...
import { canDeactivateGuard, formCanActivateGuard } from './can-deactivate.guard';
...
export const routes: Routes = [
    ...
    { path: "Edit/:empId", component: ResourceFormComponent, canDeactivate: [canDeactivateGuard],canActivate: [formCanActivateGuard]},
